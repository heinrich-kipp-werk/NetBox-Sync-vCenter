    ...
    def prune_data(self):
        ...
        for nb_object_sub_class in reversed(NetBoxObject.__subclasses__()):
            ...
            for this_object in self.inventory.get_all_items(nb_object_sub_class):
                ...
                if last_updated is not None and days_since_last_update >= self.settings.prune_delay_in_days and nb_object_sub_class.name != "device" and nb_object_sub_class.name != "interface":
